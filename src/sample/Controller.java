    ...
    public static class LocationTagContent {
        ...
        /* Check if o is an instance of Complex or not
          "null instanceof [type]" also returns false */
            if (!(o instanceof LocationTagContent)) {
                return false;
            }

            // typecast o to Complex so that we can compare data members
            LocationTagContent l = (LocationTagContent) o;

            // Compare the data members and return accordingly
            return name.equals(l.name)
                    && streetOne.equals(l.streetOne)
                    && streetTwo.equals(l.streetTwo)
                    && arrivalTime.equals(l.arrivalTime)
                    && coordLocation.equals(l.coordLocation)
                    && request.equals(l.request)
                    && chemin.equals(l.chemin)
                    && Boolean.compare(isPickup, l.isPickup) == 0;
        }
    }
